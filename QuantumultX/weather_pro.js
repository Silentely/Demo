 ...
 */
let config = {
    darksky_api: "dd4af7f593f57478094c331198f8aa64", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "6193dd50343b61246f049f3811a5287c6267f49e", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "4f796d7d847d4be0a3c4ec880cb05e2c", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取(注意key类型选WebApi)
    lat_lon: "23.0015,113.2545", //请填写经纬度,直接从谷歌地图中获取即可
    ...
    show: {
        //普通每天的
        template: {
            title: `$[province]$[city]$[district] $[summary]`,
