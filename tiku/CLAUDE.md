...
### 2025-12-19
- **v1.1.1 功能增强**
  - 判断题答案识别新增罗马数字 ⅹ/Ⅹ 及更多叉号变体（❌、✕、⨯ 等）
  - 去重功能增强：显示原题库位置信息（工作表名+行号）
  - 便于快速定位和处理重复题目
...
| 脚本名 | 版本 | 功能 | 输出格式 |
|-------|------|------|---------|
| `convert_all_questions_motibang.py` | v1.1.1 | 多格式转磨题帮模板 | 磨题帮 Excel 模板 |
| `convert_all_questions_shuatidadang.py` | v1.1.1 | 多格式转刷题搭档模板 | 刷题搭档 Excel 模板 |
...
### 判断题答案规范化
支持的输入格式:
- 正确: `Y/YES/T/TRUE/1/对/正确/√/✓/是/○/〇/O`
- 错误: `N/NO/F/FALSE/0/错/错误/×/✗/✘/否/X/ⅹ/Ⅹ/❌/✕/⨯/⨉/叉`

统一输出: `对` 或 `错`

> **v1.1.1 新增**: 支持罗马数字 ⅹ/Ⅹ 及更多叉号变体
...
```
tiku/
├── convert_all_questions_motibang.py        # 磨题帮转换脚本 v1.1.1 (1350+ 行)
├── convert_all_questions_shuatidadang.py    # 刷题搭档转换脚本 v1.1.1
