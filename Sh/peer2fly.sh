...
# 多开peer2
# wget https://raw.githubusercontent.com/Silentely/Demo/new/main/Sh/peer2fly.sh
# 给予权限
# chmod +x peer2fly.sh
# 运行
...
function download_compose_file() {
    ...
    wget -q https://gist.githubusercontent.com/Silentely/2daa367081c60562b0d860daf219dba6/raw/ff312de98cf99d8f040994c88d5f50a152edfced/docker-compose.yml -O docker-compose.yml
}
...
function set_proxy() {
    ...
    if [ ! -f ./proxychains4.conf ]; then
        ...
        wget -q https://gist.githubusercontent.com/Silentely/2daa367081c60562b0d860daf219dba6/raw/ff312de98cf99d8f040994c88d5f50a152edfced/proxychains4.conf -O proxychains4.conf
    else
